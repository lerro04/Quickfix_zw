...
$totalRevenue=$pdo->query("SELECT COALESCE(SUM(agreed_amount),0) as t FROM bookings WHERE payment_status='released'")->fetch()['t'];
$todayRevenue=$pdo->query("SELECT COALESCE(SUM(agreed_amount),0) as t FROM bookings WHERE payment_status='released' AND DATE(completed_at)=CURDATE()")->fetch()['t'];
...
<div class="page-title">📊 Platform Analytics</div>
<div class="card-grid" style="margin-bottom:1.5rem">
  <div class="stat-card" style="border-left-color:var(--success)"><div class="stat-icon" style="background:var(--success)">💰</div><div class="stat-info"><h3>$<?=number_format($totalRevenue,2)?></h3><p>All-Time Revenue</p></div></div>
  <div class="stat-card" style="border-left-color:var(--accent)"><div class="stat-icon" style="background:var(--accent)">📅</div><div class="stat-info"><h3>$<?=number_format($todayRevenue,2)?></h3><p>Today's Revenue</p></div></div>
</div>

<div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;margin-bottom:1.5rem">
  <div class="card">
    <div class="card-header">🔧 Bookings by Trade</div>
    <div class="card-body">
      ...
      <div style="margin-bottom:0.8rem">
        ...
        <?php $maxBook=max(array_column($topTrades,'bookings'))?:1; ?>
  ...
  <div class="card">
    <div class="card-header">🏆 Top Professionals by Earnings</div>
    <div class="card-body">
      ...
      <tr>
        ...
        <td><?=number_format($p['rating_avg'],1)?> ⭐</td>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem">
  <div class="card">
    <div class="card-header">📍 Top Job Locations</div>
    <div class="card-body">
      <table><thead><tr><th>Location</th><th>Jobs Posted</th></tr></thead><tbody>
      <?php foreach($topLocations as $l): ?>
      <tr><td>📍 <?=$l['location']?></td><td><strong><?=$l['count']?></strong></td></tr>
      <?php endforeach; ?>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <table><thead><tr><th>Month</th><th>Bookings</th><th>Revenue</th></tr></thead><tbody>
