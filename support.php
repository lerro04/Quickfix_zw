...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['contact_submit'])){
 ...
 $old['phone'] = normalizePhone($_POST['phone'] ?? '');
 ...
 } elseif($old['phone'] !== '' && !isValidPhone($old['phone'])){
...
<div class="container"><br>
 ...
 <input type="tel" name="phone" class="form-control" value="<?=htmlspecialchars($old['phone'])?>" placeholder="0779913031" pattern="0\d{9}" title="10 digits starting with 0 (e.g. 0779913031)">
 </div>
 <div class="form-group">
