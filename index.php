...
<div style="background:linear-gradient(135deg,#1a1a2e 0%,#c44d00 100%);min-height:100vh;display:flex;flex-direction:column">
  <nav style="display:flex;justify-content:space-between;align-items:center;padding:1.2rem 2rem">
    <div style="color:white;font-size:1.6rem;font-weight:800">🔧 Quick<span style="color:#f96a15">Fix</span> ZW</div>
  ...
  <div style="flex:1;display:flex;align-items:center;justify-content:center;flex-wrap:wrap;gap:3rem;padding:3rem 2rem">
    <!-- LEFT: Hero Text -->
    <div style="color:white;max-width:480px">
      ...
      <p style="font-size:1.1rem;opacity:0.85;margin-bottom:2rem;line-height:1.7">
        Post a job and get bids from verified local plumbers, electricians, painters, carpenters and more — or browse professionals and book directly.
      </p>
      <div style="display:flex;flex-wrap:wrap;gap:0.8rem">
        <span style="background:rgba(255,255,255,0.15);padding:0.5rem 1rem;border-radius:25px;font-size:0.85rem">🔧 Plumbing</span>
        <span style="background:rgba(255,255,255,0.15);padding:0.5rem 1rem;border-radius:25px;font-size:0.85rem">⚡ Electrical</span>
        <span style="background:rgba(255,255,255,0.15);padding:0.5rem 1rem;border-radius:25px;font-size:0.85rem">🖌️ Painting</span>
        <span style="background:rgba(255,255,255,0.15);padding:0.5rem 1rem;border-radius:25px;font-size:0.85rem">🪚 Carpentry</span>
        <span style="background:rgba(255,255,255,0.15);padding:0.5rem 1rem;border-radius:25px;font-size:0.85rem">🏠 Tiling</span>
        <span style="background:rgba(255,255,255,0.15);padding:0.5rem 1rem;border-radius:25px;font-size:0.85rem">🏗️ Roofing</span>
      </div>
    </div>
