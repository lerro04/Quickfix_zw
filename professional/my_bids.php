...
<title>My Bids â€” QuickFix ZW</title>
<link rel="stylesheet" href="<?= BASE_URL ?>/css/style.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css">
</head><body>
<?php include '../includes/navbar.php'; ?>
<div class="container"><br>
<div class="page-title">ðŸ’° My Bids (<?=count($myBids)?>)</div>
<?php if(empty($myBids)): ?>
...
<div class="job-card">
  <div style="display:flex;justify-content:space-between;flex-wrap:wrap;gap:0.8rem">
    <div>
      ...
      <div class="job-meta">
        <span>ðŸ‘¤ <?=$b['client']?></span>
        <span>ðŸ“ <?=$b['location']?></span>
        <span>ðŸ’µ Client budget: $<?=number_format($b['client_budget'],2)?></span>
    ...
    <div style="text-align:right">
      ...
      <div style="font-size:0.8rem;color:#999">â± <?=$b['estimated_days']?> day(s)</div>
  ...
  <div style="margin-top:0.8rem;padding:0.7rem;background:#d4edda;border-radius:8px;font-size:0.88rem;color:#155724">
    âœ… <strong>Your bid was accepted!</strong> Check <a href="<?= BASE_URL ?>/professional/bookings.php" style="color:var(--success)">My Bookings</a> for details.
  </div>
  <?php endif; ?>
</div>
<?php endforeach; ?>
