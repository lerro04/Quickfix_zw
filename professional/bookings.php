...
<div class="card-grid" style="margin-bottom:1.5rem">
 <div class="stat-card" style="border-left-color:var(--success)"><div class="stat-icon" style="background:var(--success)"><?=icon('money-bill-wave')?></div><div class="stat-info"><h3>$<?=number_format($earned,2)?></h3><p>Total Earned</p></div></div>
...
<div class="job-card">
 ...
 <span><?=icon('calendar-day')?> <?=$b['scheduled_date']??'Date TBD'?></span>
 </div>
 ...
 <?=icon('circle-check')?> Job completed. Payment <?=$b['payment_status']==='released'?'has been released to you':'is being processed'?>.
 </div>
 <?php endif; ?>
</div>
<?php endforeach; ?>
